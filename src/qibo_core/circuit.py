...
class _Queue(list):
    ...
    def to_fused(self):
        """Transform all gates to :class:`qibo_core.gates.FusedGate`."""
        last_gate = {}
...
class Circuit:
    ...
    def _distributed_init(self, nqubits, accelerators):  # pragma: no cover
        ...
        :class:`qibo_core.models.circuit.Circuit`.
        ...
        from qibo_core.models.distcircuit import DistributedQueues
    ...
    def light_cone(self, *qubits):
        ...
        Returns:
            circuit (qibo_core.circuit): Circuit that contains only
    ...
    def _shallow_copy(self):
        """Helper method for :meth:`qibo_core.circuit.Circuit.copy` and
        :meth:`qibo_core.circuit.Circuit.fuse`."""
    ...
    def invert(self):
        ...
        are updated afterwards, for example using :meth:`qibo_core.circuit.Circuit.set_parameters`,
        ...
        Returns:
            The circuit inverse.
        """
        from qibo_core.gates import ParametrizedGate
    ...
    def add(self, gate):
        ...
        Args:
            gate (:class:`qibo_core.gates.Gate`): the gate object to add.
    ...
    def get_parameters(
        ...
        Inverse method of :meth:`qibo_core.circuit.Circuit.set_parameters`.

        Args:
            format (str): How to return the variational parameters.
                Available formats are ``'list'``, ``'dict'`` and ``'flatlist'``.
                See :meth:`qibo_core.circuit.Circuit.set_parameters`
    ...
    def fuse(self, max_qubits=2):
        ...
        Returns:
            A :class:`qibo_core.circuit.Circuit` object containing
            :class:`qibo_core.gates.FusedGate` gates, each of which
    ...
    def execute(self, initial_state=None, nshots=1000):
        ...
        Args:
            initial_state (`np.ndarray` or :class:`qibo_core.circuit.Circuit`):
    ...
    def raw(self) -> dict:
        ...
        return {
            ...
            "qibo_version": qibo_core.__version__,
        }
    ...
    def from_qasm(cls, qasm_code, accelerators=None, density_matrix=False):
        ...
        Returns:
            A :class:`qibo_core.circuit.Circuit` that contains the gates
    ...
    def _update_draw_matrix(self, matrix, idx, gate, gate_symbol=None):
        """Helper method for :meth:`qibo_core.circuit.Circuit.draw`."""
